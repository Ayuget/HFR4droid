...
{	
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		else if (item.getItemId() == R.id.MenuMps)
		{
		...
		else if (item.getItemId() == R.id.MenuNavPreviousPage)
		{
			loadPreviousPage();
			return true;
		}
		else if (item.getItemId() == R.id.MenuNavUserPage)
		{
			loadUserPage();
			return true;
		}
		else if (item.getItemId() == R.id.MenuNavNextPage)
		{
			loadNextPage();
			return true;
		}
		else if (item.getItemId() == R.id.MenuNavLastPage)
		{
			loadLastPage();
			return true;
		}
